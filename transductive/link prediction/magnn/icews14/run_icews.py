...
def run_model_LastFM(feats_type, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    adjlists_ua, edge_metapath_indices_list_ua, _, type_mask, train_val_test_pos_user_artist, train_val_test_neg_user_artist = load_LastFM_data(prefix=f'/home/nxz190009/phd/MAGNN/reorganized/transductive/link prediction/{dataset}/data/preprocessed/{dataset}_processed')
    ...
    for _ in range(repeat):
        ...
        for epoch in range(num_epochs):
            ...
            for iteration in range(train_pos_idx_generator.num_iterations()):
                ...
                # if iteration == 1: break #Delete this
...
if __name__ == '__main__':
    ...
    ap.add_argument('--save-postfix', default=f'{dataset}_transductive_lp', help='Postfix for the saved model and result. Default is LastFM.')
