...
def load_truncated_icews18_nc_actor1_actor2_no_events(prefix='data/preprocessed/icews18_nc_actor1_actor2_no_events'):
    G01 = nx.read_adjlist(prefix + '/0/0-1.adjlist', create_using=nx.MultiDiGraph)
    G10 = nx.read_adjlist(prefix + '/1/1-0.adjlist', create_using=nx.MultiDiGraph)

    idx01 = np.load(prefix + '/0/0-1_idx.npy')
    idx10 = np.load(prefix + '/1/1-0_idx.npy')
...
def load_truncated_icews18_nc_data(prefix='data/preprocessed/icews18_nc_truncated_processed'):
    G00 = nx.read_adjlist(prefix + '/0/0-1-0.adjlist', create_using=nx.MultiDiGraph)
    G01 = nx.read_adjlist(prefix + '/0/0-2-0.adjlist', create_using=nx.MultiDiGraph)
    G10 = nx.read_adjlist(prefix + '/1/1-0-1.adjlist', create_using=nx.MultiDiGraph)
    G11 = nx.read_adjlist(prefix + '/1/1-0-2-0-1.adjlist', create_using=nx.MultiDiGraph)
...
def load_LastFM_ua_data(prefix='data/preprocessed/LastFM_processed'):
    in_file = open(prefix + '/0/0-1-0.adjlist', 'r')
    adjlist00 = [line.strip() for line in in_file]
    adjlist00 = adjlist00
    in_file.close()
